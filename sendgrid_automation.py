#!/usr/bin/env python3
"""
SendGrid Email Automation for Zyeuté Québec
"""
...
FROM_EMAIL = "zyeutequebec@gmail.com"  # Verified sender in SendGrid
REPLY_TO_EMAIL = os.getenv("REPLY_TO_EMAIL", "northern-ventures@outlook.com")  # Where replies go
...
def send_email_sendgrid(to_email, subject, body):
    ...
    if not SENDGRID_API_KEY:
        ...
        print("Set it with: $env:SENDGRID_API_KEY='your-api-key'")
        return False
...
def send_audit_email(audit_result, recipient_email, recipient_name=None):
    ...
    # Send email
    success = send_email_sendgrid(recipient_email, subject, body)
...
if __name__ == "__main__":
    print("=" * 70)
    print("SENDGRID EMAIL AUTOMATION TEST")
    print("=" * 70)
    ...
    if os.path.exists(test_audit_path):
        ...
        print()
        print("=" * 70)
        print("To send test email:")
        print("1. Set API key: $env:SENDGRID_API_KEY='your-key'")
